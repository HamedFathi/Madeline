...
export class SetAccessorExtractor {
    public extract(node: SetAccessorDeclaration, imports: ImportInfo[] | undefined): SetAccessorInfo {
        ...
        const typeParameters = new TypeParameterExtractor().extract(node, TypeScope.SetAccessors, imports);
        ...
        return {
            ...
            parameter: node.getParameters().map(y => {
                return {
                    ...
                    type: new TypeExtractor().extract(y.getType(), TypeScope.Classes, y.getTypeNode(), void 0, imports),
                };
            })[0],
